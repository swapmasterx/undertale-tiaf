...
@export_range(0, 999999, 0.001, "hide_slider", "suffix:s") var death_after_time:float = 30
...
@export_range(0, 999999, 0.001, "hide_slider", "suffix:s") var death_pause_remove_after:float = 0
